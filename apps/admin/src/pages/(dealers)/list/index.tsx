...
import { CreateDealer } from "./_components/CreateDealer";
import {
  useListDealers,
  type IDealerData,
...
const DealersList = () => {
  ...
  const columns: ColumnsType<IDealerData> = [
    ...
    },
    {
      ...
      children: [
        {
          title: "GN",
          dataIndex: ["dealer", "genuinePartsTier"],
          key: "tierGN",
          width: 80,
        },
        {
          title: "ES",
          dataIndex: ["dealer", "aftermarketESTier"],
          key: "tierES",
          width: 80,
        },
        {
          title: "B",
          dataIndex: ["dealer", "aftermarketBTier"],
          key: "tierB",
          width: 80,
        },
      ],
    ...
    {
      title: "Status",
      dataIndex: ["dealer", "accountStatus"],
      key: "status",
      width: 120,
  ...
  return (
    <div className="w-full h-full flex flex-col">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            View, manage, and maintain detailed records of all registered
            dealers.
          </p>
        </div>
        <Button
      ...
      <CreateDealer open={drawerOpen} onClose={() =>{
        refetch();
        setDrawerOpen(false)}} />
    </div>
  );
